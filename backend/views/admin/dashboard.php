...
.dashboard-stat-icon { align-items: center; background: #e8f1f4; color: var(--stat-color); display: inline-flex; font-size: .7rem; font-weight: 900; height: 2.25rem; justify-content: center; width: 2.25rem; }
...
.live-activity { max-height: 390px; overflow-y: auto; padding: 0 1.25rem 1rem; }.activity-row { align-items: center; border-top: 1px solid #e5edf1; display: flex; gap: .75rem; padding: .8rem 0; }.activity-avatar { align-items: center; background: #e8f1f4; color: var(--dashboard-blue); display: flex; flex: 0 0 2.15rem; font-size: .75rem; font-weight: 800; height: 2.15rem; justify-content: center; }.activity-details { display: grid; min-width: 0; }.activity-details strong { font-size: .86rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.activity-details span { color: var(--dashboard-muted); font-size: .75rem; margin-top: .15rem; }.activity-meta { align-items: flex-end; display: grid; gap: .25rem; margin-left: auto; text-align: right; }.activity-meta small { color: var(--dashboard-muted); font-size: .7rem; }.activity-badge { font-size: .65rem; font-weight: 900; padding: .25rem .4rem; }.activity-badge--in { background: #e2f4f2; color: var(--dashboard-green); }.activity-badge--out { background: #edf0f2; color: #66717a; }.activity-empty { color: var(--dashboard-muted); padding: 2rem 0; text-align: center; }
