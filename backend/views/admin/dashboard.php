...
.dashboard-stat { background: #27ca81; border: 1px solid var(--dashboard-border); border-top: 3px solid var(--stat-color); min-height: 154px; padding: 1.1rem 1.15rem; }
...
.dashboard-stat-icon { align-items: center; background: #9326e6; color: var(--stat-color); display: inline-flex; font-size: .7rem; font-weight: 900; height: 2.25rem; justify-content: center; width: 2.25rem; }
