...
.time-report-page { --reports-yellow: #d4a94d; --reports-ink: #10233e; --reports-border: #dfe7ee; color: var(--reports-ink); }
...
.report-table-panel thead th { background: #eef5f7; border-bottom: 1px solid var(--reports-border); color: #5b6f82; font-size: .68rem; letter-spacing: .06em; padding: .75rem 1.15rem; text-transform: uppercase; }
...
.report-status--inside { background: #e2f4f2; color: #007875; }
.report-status--out { background: #edf0f2; color: #66717a; }
.report-filter { align-items: end; background: #f8fafb; border: 1px solid var(--reports-border); display: flex; gap: .75rem; padding: 1rem 1.15rem; }
