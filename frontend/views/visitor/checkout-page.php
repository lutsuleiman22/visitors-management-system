...
$this->registerJs(
    ...
    . 'const continueButton = document.getElementById("continue-checkout");'
    ...
    . 'setContinueState(true);'
    . '}'
    . 'searchInput.addEventListener("input", applyCurrentSearch);'
    . 'searchInput.addEventListener("change", applyCurrentSearch);'
    . 'setContinueState(searchInput.value.trim().length > 0);'
    . 'if (searchInput.value.trim()) { applyCurrentSearch(); }'
